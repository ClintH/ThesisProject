...
zoneBtns.forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    // Reset scroll position when switching to magnetic
    // so the snap pull doesn't feel jarring
...
function resize() {
  ...
  state.cssH = window.innerHeight - (document.getElementById('ui').offsetHeight || 28);
